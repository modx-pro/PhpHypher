...
$snippet->fromArray(array(
    'name' => PKG_NAME,
    'description' => PKG_NAME . ' for MODX Revolution',
    'category' => 0,
    'snippet' => file_get_contents($sources['source_core'] . '/elements/snippets/snippet.' . PKG_NAME_LOWER . '.php'),
    'source' => 1,
    'static' => 0,
    'static_file' => 'core/components/' . PKG_NAME_LOWER . '/elements/snippets/snippet.' . PKG_NAME_LOWER . '.php',
));
